...
The above results show that `Roxanne Rodriguez` recorded several losses while `Fred Suzuki` had none. This resulted in the lower profit generated by `Roxanne Rodriguez`.  

Although Technology has the lowest number of orders, it generated the most profits to the superstore. This may be due to the high sales price of the technology product as shown in the previous customer query. Thus, the following query is used to obtain the number of orders in each sub-category of Technology and their sum of profits:

```sql
SELECT Manager, Sub_Category, COUNT(Sub_Category) AS Count, SUM(Profit) AS Profits
FROM manager JOIN superstore
ON manager.Region = superstore.Region
WHERE Category = "Technology"
GROUP BY Manager, Sub_Category
ORDER BY Manager, Profits DESC;
```

| Manager           | Sub_Category | Count | Profits             |
|-------------------|--------------|-------|---------------------|
| Chuck Magee       | Copiers      | 22    | 17498.9534          |
| Chuck Magee       | Phones       | 280   | 12818.315100000002  |
| Chuck Magee       | Accessories  | 206   | 11195.864400000008  |
| Chuck Magee       | Machines     | 37    | 6928.642900000002   |
| Fred Suzuki       | Phones       | 140   | 10767.275300000001  |
| Fred Suzuki       | Accessories  | 128   | 7004.542399999998   |
| Fred Suzuki       | Copiers      | 7     | 3658.9067           |
| Fred Suzuki       | Machines     | 18    | -1438.8929999999998 |
| Roxanne Rodriguez | Copiers      | 16    | 15608.841299999998  |
| Roxanne Rodriguez | Phones       | 200   | 12323.026699999997  |
| Roxanne Rodriguez | Accessories  | 183   | 7251.6306           |
| Roxanne Rodriguez | Machines     | 21    | -1486.0666          |
| Sadie Pawthorne   | Copiers      | 25    | 19327.235099999998  |
| Sadie Pawthorne   | Accessories  | 258   | 16484.598299999998  |
| Sadie Pawthorne   | Phones       | 283   | 9142.209400000005   |
| Sadie Pawthorne   | Machines     | 41    | -541.7064000000004  |

From the results, it shows that the profits generated by `Sadie Pawthorne` just by selling 25 Copiers already surpassed the profits generated in the Furniture category which had 735 orders.

Although Machines has the highest sales prices, the huge discount makes them a loss deal as shown by `Fred Suzuki`, `Roxanne Rodriguez` and even `Sadie Pawthorne`.
